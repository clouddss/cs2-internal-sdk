...
namespace ImGui
{
    ...
    IMGUI_API bool MultiCombo(const char* szLabel, unsigned int* pFlags, const char* const* arrItems, int nItemsCount);
...
struct ImFontConfig
{
    ...
    bool            FreeFontData;           // true     // Should free font data
    ...
    int             GlyphPadding[4];        // 0, 0, 0, 0 // Extra glyph padding for additional effects like shadow. [top, right, bottom, left]
